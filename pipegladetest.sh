...
check 1 "statusbar1:push Select \"FIRST\" from the combobox\n comboboxtext1:prepend_text FIRST" "comboboxtext-entry:text FIRST"
check 1 "statusbar1:push Select \"LAST\" from the combobox\n comboboxtext1:append_text LAST" "comboboxtext-entry:text LAST"
check 1 "statusbar1:push Select \"AVERAGE\" from the combobox\n comboboxtext1:insert_text 3 AVERAGE" "comboboxtext-entry:text AVERAGE"
check 1 "statusbar1:push Select the second entry from the combobox\n comboboxtext1:remove 0" "comboboxtext-entry:text def"
check 2 "statusbar1:push Click the \"+\" of the spinbutton \n button1:set_label OK" "spinbutton1:text 33.00" "spinbutton1:text 34.00"
